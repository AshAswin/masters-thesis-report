...
\begin{document}
	...
	The previous chapter gave necessary background knowledge, for the reader to understand this research work. This chapter emphasizes on Explainable Artificial Intelligence (XAI) methods developed for convolutional neural network (CNN) models such as GestaltMatcher. The set of methods considered for this research work are categorized and explained in a concise manner. 
