...
\begin{document}
    ...
    \subsubsection{D. Evaluation Procedure}
     \begin{figure}[ht]    
    	\includegraphics[scale=0.7,trim = 0cm 0cm 0cm 0cm]{chapter4/patient_wise_tree.pdf}
    	\caption{Proposed procedure to evaluate patient-wise attribution maps}
    \end{figure}
	\begin{figure}[ht]    
		\includegraphics[scale=0.6,trim = 0cm 0cm 0cm 0cm]{chapter4/composite_face_tree.pdf}
