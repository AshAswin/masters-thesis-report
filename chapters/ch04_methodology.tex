...
\begin{document}
	...
	The UTKFace \cite{zhifei2017cvpr} is used for the dataset imbalance - explanation quality experiment   \ref{sec_data_imb} that requires faces from a healthy cohort. The dataset has over 20,000 face images with labels for age, gender, and ethnicity. For the experiment, we handpick 244 samples from the dataset while ensuring the diversity of the dataset.
		...
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/gmdb_examples/file-1.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/gmdb_examples/file-2.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/gmdb_examples/file-3.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/gmdb_examples/file-4.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/gmdb_examples/file-5.jpg}
		\end{subfigure}
			\begin{subfigure}[b]{0.17\textwidth}
		\centering
		\includegraphics[width=\textwidth]{chapter4/gmdb_examples/file-6.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
		\centering
		\includegraphics[width=\textwidth]{chapter4/gmdb_examples/file-7.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
		\centering
		\includegraphics[width=\textwidth]{chapter4/gmdb_examples/file-8.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
		\centering
		\includegraphics[width=\textwidth]{chapter4/gmdb_examples/file-9.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
		\centering
		\includegraphics[width=\textwidth]{chapter4/gmdb_examples/file-10.jpg}
		\end{subfigure}
		...
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/utk_examples/file-1.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/utk_examples/file-2.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/utk_examples/file-3.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
		\centering
		\includegraphics[width=\textwidth]{chapter4/utk_examples/file-4.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/utk_examples/file-5.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/utk_examples/file-6.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/utk_examples/file-7.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
			\centering
			\includegraphics[width=\textwidth]{chapter4/utk_examples/file-8.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
		\centering
		\includegraphics[width=\textwidth]{chapter4/utk_examples/file-9.jpg}
		\end{subfigure}
		\begin{subfigure}[b]{0.17\textwidth}
		\centering
		\includegraphics[width=\textwidth]{chapter4/utk_examples/file-10.jpg}
		\end{subfigure}
	...
	\begin{figure}[H]
		\hspace*{1cm}      
		\includegraphics[scale=0.7,trim = 0cm 7cm 0cm 0cm]{chapter4/composite_face_tree.pdf}
		\vspace*{4cm}
	...
	\begin{figure}[H]
		\hspace*{4.5cm}      
		\includegraphics[scale=0.7]{chapter4/syndrome_wise_tree.pdf}
