...
%	\end{figure}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|l|l|}
			...
			Loss function           & \begin{tabular}[c]{@{}l@{}}cross entropy loss\\weighted by inverse\\of class frequencies\end{tabular} \\ \hline
